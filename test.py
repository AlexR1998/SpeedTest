...
class Test:
    ...
    def TestExecution(self):
        ...
        self.__data.append(round(self.__s.download()/1048576,2))
        self.__data.append(round(self.__s.upload()/1048576,2))
        ...
        self.__data.append(self.__s.get_best_server()['latency'])
        return self.__data

t=Test()

#print(t.TestExecution())